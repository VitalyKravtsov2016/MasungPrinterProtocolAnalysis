...
//    }
    ...
    public static byte[] PrintDiskImagefile(int[] pixels, int iWidth, int iHeight) {
        try
        {
            ...
            int iResult = JNAData1.INSTANCE.Data1PrintImage(ptr,iWidth,iHeight);
            if(iResult > 0) {
...
//    }
    ...
    public static String JNAByteToString(int[] bData)
    {
        int iIndex = 0;
        int iValue1 = 0;
        int iValue2 = 0;
...
//    public static byte[] Data1PrintPDF417BMP(int module_width,int module_height,int data_rows,int data_columns,int err_correct_level,String data_buf,int data_length)
//    {
//        try
//        {
//            int iResult = JNAData1.INSTANCE.Data1PrintPDF417Bmp(module_width,module_height,data_rows,data_columns,err_correct_level,data_buf,data_length);
//            if(iResult > 0) {
//                String strPrintData = JNAData1.INSTANCE.Data1GetPrintDataA();
//                byte[] bData =JNAStringToByte(strPrintData,iResult);
//                JNAData1.INSTANCE.Data1Release();
